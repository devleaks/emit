 ...
 */
exports.cleanCopy = function(f) {
    return JSON.parse(JSON.stringify(f))
}

// Remove temporary objects stored for this simulator
exports.removeTemporaryProperties = function(f, remove = ["marker", "nearestPointOnLine", "idx"]) {
...
exports.close = function(p1, p2, precision) {
...
exports.close_distance = function(p1, p2, d) {
