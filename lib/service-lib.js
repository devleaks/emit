...
function refill(truck, airport) {
    ...
    console.log("refill", truck.getProp("service"), truck._points.length, truck.getProp("syncCount"), truck._track.length - 1)
    truck.addMarker(
        refillStation,
        0,
...
function serve(service, truck, airport) {
    ...
    console.log("serve", truck.getProp("service"), truck._points.length, truck.getProp("syncCount"), truck._track.length - 1)
    truck.addMarker(
        parking,
        0,
 ...
 */
function prepareAllServices(services, airport) {
    var servicesByType = {}
