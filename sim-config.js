...
exports.simulation = {
    ...
    "time-between-flights": [0,15],     // minimum and maximum time between fights. Exact time rounded to 2.5 minutes.
    "min-flight-distance": 2.5,         // minimum time (minutes) between 2 flights.
